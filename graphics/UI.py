...
class Graphic:
    ...
    def print_match(self, chess_match, elements=None):
        self.print_graphics(chess_match.get_pieces(), False, elements)
        print()
    ...
    def print_graphics(self, pieces, possible_moves=False, elements=None):
        if not elements:
            elements = range(len(pieces))
        for i in elements:
            print(8 - i, end="  ")
